#!/bin/bash
#SBATCH --job-name=sae_mistral
#SBATCH --output=logs/sae_mistral_%j.out
#SBATCH --error=logs/sae_mistral_%j.err
...
echo "Starting SAE training for mistral on Bouchet"
date
hostname
...
echo "Finished SAE training for mistral"
date
