#!/bin/bash
#SBATCH --job-name=sae_llama2
#SBATCH --output=logs/sae_llama2_%j.out
#SBATCH --error=logs/sae_llama2_%j.err
...
echo "Starting SAE training for llama2 on Bouchet"
date
hostname
nvidia-smi || echo "nvidia-smi not available?"

# Load modules (match what you used before)
...
echo "Finished SAE training for llama2"
date
